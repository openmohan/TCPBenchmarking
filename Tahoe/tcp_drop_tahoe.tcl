...
set outputfile [open $argv/out.tr w]
$ns trace-all $outputfile
set namfile [open $argv/out.nam w]
...
proc drop_1 {} {
    ...
    # Run the packaet simulation from 1s to 7s, so 6s
    ...
    $ns at 7.0 "finish"         ;# Finish the simulation after 7.0 s
...
proc finish {} {
    ...
    close $namfile
    close $outputfile
    # cat out.tr | ./pkgplot.pl tahoe
    # exec xgraph throughput.tahoe -geometry 800x400 &
